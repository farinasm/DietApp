    ...
    return CustomScrollView(
      slivers: [
        SliverAppBar.large(
          ...
          actions: [
            IconButton(onPressed: _editTargets, tooltip: "Objetivos", icon: const Icon(Icons.tune_rounded)),
            IconButton(onPressed: _regenAllThisDay, tooltip: "Regenerar día", icon: const Icon(Icons.refresh_rounded)),
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                _SectionHeader(
                  title: "Comidas",
                  subtitle: "Platos + cantidades ajustados a tus macros",
                  trailing: TextButton(onPressed: _regenAllThisDay, child: const Text("Regenerar")),
                ),
  ...
  Widget build(BuildContext context) {
    ...
    return _Card(
      child: Column(
        ...
        children: [
          Text("Objetivos de hoy", style: t.titleMedium),
          const SizedBox(height: 12),
          _Bar(label: "kcal", value: total.kcal, target: targets.kcal, color: const Color(0xFF0A84FF)),
          const SizedBox(height: 10),
          _Bar(label: "Proteína", value: total.p, target: targets.p, color: const Color(0xFF34C759)),
          const SizedBox(height: 10),
          _Bar(label: "Carbs", value: total.c, target: targets.c, color: const Color(0xFFFF9F0A)),
          const SizedBox(height: 10),
          _Bar(label: "Grasa", value: total.f, target: targets.f, color: const Color(0xFFAF52DE)),
          const SizedBox(height: 12),
          Row(
            children: [
      ...
      child: Column(
        ...
        children: [
          ...
          const Align(
            ...
            child: Text("Editar objetivos", style: TextStyle(fontSize: 18, fontWeight: FontWeight.w800)),
          ),
          ...
          Row(
            children: [
              ...
              Expanded(child: TextField(controller: p, keyboardType: TextInputType.number, decoration: const InputDecoration(labelText: "Proteína (g)"))),
            ],
          ),
          const SizedBox(height: 10),
          Row(
            children: [
              ...
              const SizedBox(width: 10),
              Expanded(child: TextField(controller: f, keyboardType: TextInputType.number, decoration: const InputDecoration(labelText: "Grasa (g)"))),
            ],
          ),
          const SizedBox(height: 14),
          SizedBox(
