...
class WeekGridScreen extends StatelessWidget {
  ...
  static const dayNamesShort = ["L", "M", "X", "J", "V", "S", "D"];
  static const dayNamesLong = ["Lunes", "Martes", "Miércoles", "Jueves", "Viernes", "Sábado", "Domingo"];
  ...
  Widget build(BuildContext context) {
    ...
    return CustomScrollView(
      slivers: [
        SliverAppBar.large(
          title: Text("Semana", style: t.headlineLarge),
          actions: [
            IconButton(
              tooltip: "Objetivos",
          ...
          child: Padding(
            ...
            child: _Card(
              child: Column(
                ...
                children: [
                  Text("Semana (arrastrar para intercambiar)", style: t.titleMedium),
                  const SizedBox(height: 6),
                  Text("Toca una celda para editar ESE menú (p.ej. Comida del martes).", style: t.bodySmall),
                ],
              ),
            ),
          ),
      ...
      child: Column(
        ...
        children: [
          ...
          const Align(
            ...
            child: Text("Editar objetivos", style: TextStyle(fontSize: 18, fontWeight: FontWeight.w900)),
          ),
