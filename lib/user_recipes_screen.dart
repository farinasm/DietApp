...
class _UserRecipesScreenState extends State<UserRecipesScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return CustomScrollView(
      slivers: [
        SliverAppBar.large(
          title: Text("Meals", style: t.headlineLarge),
          actions: [
            IconButton(
              tooltip: "New Meal",
          ...
          child: Padding(
            ...
            child: _Card(
              child: Column(
                ...
                children: [
                  Text("Your Recipes", style: t.titleMedium),
                  const SizedBox(height: 6),
                  Text("Create dishes and the planner will use them to generate DAY and WEEK.", style: t.bodySmall),
                ],
              ),
            ),
          ),
            ...
            child: Padding(
              ...
              child: _Card(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    const Text("You don't have any recipes yet.", style: TextStyle(fontWeight: FontWeight.w900, fontSize: 16)),
                    const SizedBox(height: 8),
                    const Text("Create at least 1 recipe for each meal (Breakfast/Lunch/Snack/Dinner)."),
                    ...
                    FilledButton.icon(
                      ...
                      icon: const Icon(Icons.add_rounded),
                      label: const Text("Create First Dish"),
                    ),
                  ],
                ),
              ),
                    ...
                    children: [
                      Expanded(
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          const SizedBox(height: 6),
                          Text("${r.items.length} ingredients", style: const TextStyle(color: Color(0xFF6B7280))),
                        ]),
                      ),
                      IconButton(
                        tooltip: "Edit",
      ...
      child: Column(
        ...
        children: [
          ...
          Align(
            ...
            child: Text(widget.initial == null ? "New Dish" : "Edit Dish",
          ...
          Align(
            ...
            child: Row(
              children: [
                const Text("Ingredients", style: TextStyle(fontWeight: FontWeight.w900)),
                const Spacer(),
                TextButton.icon(
                  onPressed: () {
      ...
      child: Column(
        children: [
            ...
            children: [
              ...
              Expanded(
                child: TextFormField(
                  ...
                  decoration: InputDecoration(labelText: "Step (${unitLabel(ing.unit)})"),
          ...
          Align(
            alignment: Alignment.centerLeft,
            child: Text(
              isPiece ? "Unit: pieces" : "Unit: grams (macros per 100g)",
