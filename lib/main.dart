  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: NavigationBar(
        ...
        destinations: const [
          NavigationDestination(icon: Icon(Icons.today_rounded), label: "Día"),
          NavigationDestination(icon: Icon(Icons.view_week_rounded), label: "Semana"),
          NavigationDestination(icon: Icon(Icons.restaurant_menu_rounded), label: "Platos"),
        ],
      ),
    );
  }
...
class WeekPlanStrings {
  static const _long = ["Lunes", "Martes", "Miércoles", "Jueves", "Viernes", "Sábado", "Domingo"];
