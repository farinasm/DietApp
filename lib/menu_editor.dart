            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  _SectionHeader(
                    title: "Edit Menu",
                    subtitle: "Adjust quantities or regenerate this meal",
                    trailing: TextButton(
                      onPressed: () {
                        widget.onRegenerate();
                        Navigator.pop(context);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: CustomScrollView(
        slivers: [
          SliverAppBar.large(
            title: Text(widget.initial == null ? "New meal" : "Edit meal", style: t.headlineLarge),
            actions: [
              IconButton(tooltip: "Save", onPressed: _save, icon: const Icon(Icons.check_rounded)),
              const SizedBox(width: 8),
            ],
          ),
          SliverToBoxAdapter(
                ...
                children: [
                  _Card(
                    child: Column(
                      ...
                      children: [
                        ...
                        TextField(
                          controller: nameCtrl,
                          decoration: const InputDecoration(labelText: "E.g. Chicken + rice"),
                        ),
                        const SizedBox(height: 14),
                        Text("Moments", style: t.titleMedium),
                        const SizedBox(height: 8),
                        Wrap(
                          spacing: 8,
                  ...
                  _Card(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text("Ingredients", style: t.titleMedium),
                        const SizedBox(height: 6),
                        Text(
                          "Add ingredients and adjust amounts. The role helps the optimizer (protein/carbs/fat).",
                          style: t.bodySmall,
                        ),
                  ...
                  SizedBox(
                    ...
                    height: 50,
                    child: FilledButton(onPressed: _save, child: const Text("Save meal")),
                  ),
        ...
        children: [
          Row(
            children: [
              ...
              IconButton(onPressed: onRemove, icon: const Icon(Icons.close_rounded), tooltip: "Remove ingredient"),
            ],
          ),
          const SizedBox(height: 8),
          Row(
